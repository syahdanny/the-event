  ...
  <header id="header" class="header-fixed">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        ...
        <a href="dasbor.php" class="scrollto"><img src="img/logo.png" alt="" title=""></a>
      </div>
              ...
              <div class="card mb-5 mb-lg-0">
                ...
                <hr>
                  <table id="transaksi" class="table table-stripped text-center mt-3" style="width:100%">
                    ...
                    <tbody>
                    <?php
                    $query = "SELECT * FROM transaksi where terhapus = 0 and id = $id";
                    ...
                    if (mysqli_num_rows($result) > 0){
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <tr>
                                ...
                                <td>" .$row["bayar"]. "</td>
                                <td>
                                <a href='formEditTransaksi.php?id=$id_transaksi' class='btn'>Edit</a>
                                </td>
                            </tr>
                            ";
                        }
